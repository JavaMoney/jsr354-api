...
public class MoneyTest extends RITestBase {
	...
	public void testGetCurrency() {
		MonetaryAmount money = Money.valueOf(BigDecimal.TEN, EURO);
	...
	public void testAddNumber() {
		MonetaryAmount money1 = Money.valueOf(BigDecimal.TEN, EURO);
		MonetaryAmount money2 = Money.valueOf(BigDecimal.ONE, EURO);
	...
	public void testDivideAndRemainder_BigDecimal() {
		MonetaryAmount money1 = Money.valueOf(BigDecimal.ONE, EURO);
		MonetaryAmount money2 = Money.valueOf(new BigDecimal("0.50000000000000000001"), EURO);
