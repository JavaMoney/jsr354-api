 ...
 */
package net.java.javamoney.ri.cdi.impl;
 ...
 */
@Singleton
public final class CDIRegionProvider {
	/** Loaded region providers. */
	@Inject
	private Instance<RegionProviderSpi> regionProviders;

	private static final Logger LOG = LoggerFactory
			.getLogger(CDIRegionProvider.class);
