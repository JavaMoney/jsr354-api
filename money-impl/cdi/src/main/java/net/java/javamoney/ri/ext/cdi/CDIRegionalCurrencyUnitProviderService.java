 ...
 */
package net.java.javamoney.ri.ext.cdi;
...
import net.java.javamoney.impl.cdi.CDIContainer;
 ...
 */
public final class CDIRegionalCurrencyUnitProviderService extends AbstractRegionalCurrencyUnitProviderService {
    ...
    protected Iterable<RegionalCurrencyUnitProviderSpi> getRegionalCurrentyUnitProviderSpis() {
        if (regionalCurrencyProviders == null) {
            ...
            for (RegionalCurrencyUnitProviderSpi regionalCurrencyUnitProviderSpi : CDIContainer.getInstances(RegionalCurrencyUnitProviderSpi.class)) {
