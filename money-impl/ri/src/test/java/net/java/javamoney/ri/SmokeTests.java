...
public class SmokeTests {
    ...
    private static final ExchangeRateType EZB_RATE_TYPE = ExchangeRateType.of("EZB");
    private static final ExchangeRateType IMF_RATE_TYPE = ExchangeRateType.of("IMF");

    @Test
    public void testCreateAmounts() {
	// Creating one
	CurrencyUnit currency = MonetaryCurrencies.get(MoneyCurrency.ISO_NAMESPACE, "CHF");
	...
	// Creating one
	CurrencyUnit currency = MonetaryCurrencies.get(MoneyCurrency.ISO_NAMESPACE, "INR");
	...
	ConversionProvider prov = MonetaryConversions.getConversionProvider(EZB_RATE_TYPE);
	assertNotNull(prov);
	ExchangeRate rate1 = prov.getExchangeRate(MoneyCurrency.of("CHF"), MoneyCurrency.of("EUR"));
	ExchangeRate rate2 = prov.getExchangeRate(MoneyCurrency.of("EUR"), MoneyCurrency.of("CHF"));
	ExchangeRate rate3 = prov.getExchangeRate(MoneyCurrency.of("CHF"), MoneyCurrency.of("USD"));
	ExchangeRate rate4 = prov.getExchangeRate(MoneyCurrency.of("USD"), MoneyCurrency.of("CHF"));
	...
	ConversionProvider prov = MonetaryConversions.getConversionProvider(IMF_RATE_TYPE);
	assertNotNull(prov);
	ExchangeRate rate1 = prov.getExchangeRate(MoneyCurrency.of("CHF"), MoneyCurrency.of("EUR"));
	ExchangeRate rate2 = prov.getExchangeRate(MoneyCurrency.of("EUR"), MoneyCurrency.of("CHF"));
	ExchangeRate rate3 = prov.getExchangeRate(MoneyCurrency.of("CHF"), MoneyCurrency.of("GBP"));
	ExchangeRate rate4 = prov.getExchangeRate(MoneyCurrency.of("USD"), MoneyCurrency.of("AED"));
	System.out.println(rate1);
	System.out.println(rate2);
	System.out.println(rate3);
	System.out.println(rate4);
	...
	MonetaryAmount tgt = MonetaryConversions.getConversionProvider(EZB_RATE_TYPE).getConverter()
		.convert(srcCHF, MoneyCurrency.of("EUR"));
	MonetaryAmount tgt2 = MonetaryConversions.getConversionProvider(EZB_RATE_TYPE).getConverter()
		.convert(tgt, MoneyCurrency.of("CHF"));
	assertEquals(srcCHF, tgt2);
	tgt = MonetaryConversions.getConversionProvider(EZB_RATE_TYPE).getConverter()
		.convert(srcEUR, MoneyCurrency.of("CHF"));
	tgt2 = MonetaryConversions.getConversionProvider(EZB_RATE_TYPE).getConverter()
	...
	ItemFormat<MonetaryAmount> formatter = MonetaryFormats.getItemFormat(MonetaryAmount.class,
		new LocalizationStyle.Builder(CurrencyUnit.class, "CODE").build());
	...
	ItemFormat<CurrencyUnit> formatter2 = MonetaryFormats.getItemFormat(CurrencyUnit.class, b.build());
