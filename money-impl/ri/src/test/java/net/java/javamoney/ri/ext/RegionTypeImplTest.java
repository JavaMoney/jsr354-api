...
//		RegionType t1 = RegionType.of("TypeA");
//		RegionType t2 = RegionType.of("TypeB");
//		assertNotSame(t1.hashCode(), t2.hashCode());
//	}
//
//	@Test
//	public void testOf() {
//		RegionType t1 = RegionType.of("");
//		RegionType t2 = RegionType.of("1");
//  		RegionType t4 = RegionType.of("2");
//		assertTrue(t2 == t3);
//		assertFalse(t1 == t2);
//		assertFalse(t3 == t4);
//	}
