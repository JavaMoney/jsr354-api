 ...
 * @author Werner Keil
 */
public class SECurrencyUnitValidityService extends AbstractCurrencyUnitValidityService {

    @Override
    protected Iterable<CurrencyValidity> getCurrencyValidities() {
    	return ServiceLoader.load(CurrencyValidity.class);
    }
}
