...
import static javax.money.RoundedMoney.Checker.checkAmountParameter;
import static javax.money.RoundedMoney.Checker.checkNumber;
...
public final class RoundedMoney implements MonetaryAmount,
	...
	public static RoundedMoney of(CurrencyUnit currency, BigDecimal number) {
		return new RoundedMoney(currency, number, getDefaultMathContext());
	}
