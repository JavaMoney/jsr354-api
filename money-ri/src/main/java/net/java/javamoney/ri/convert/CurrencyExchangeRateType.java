 ...
 */
public final class CurrencyExchangeRateType implements ExchangeRateType, Serializable,
		Comparable<CurrencyExchangeRateType> {
	/**
	 * serialVersionUID.
	 */
	...
	public static ExchangeRateType of(String id) {
		...
		if (instance == null) {
			instance = new CurrencyExchangeRateType(id);
	 ...
	 */
	public CurrencyExchangeRateType(String id) {
		if (id == null) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CurrencyExchangeRateType other = (CurrencyExchangeRateType) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	@Override
	public int compareTo(CurrencyExchangeRateType o) {
		if (o == null) {
			return -1;
		}
