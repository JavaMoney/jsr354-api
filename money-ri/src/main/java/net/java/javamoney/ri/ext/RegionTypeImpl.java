 ...
 */
public final class RegionTypeImpl implements RegionType, Serializable,
	...
	public static RegionType of(String id) {
		...
		if (instance == null) {
			instance = new RegionTypeImpl(id);
	...
	/**
	 * Constructs a new instance of an {@link RegionTypeImpl}.
	 * 
	 * @param id
	 *            The id of this type instance, never null.
	 */
	public RegionTypeImpl(String id) {
		if (id == null) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegionTypeImpl other = (RegionTypeImpl) obj;
		if (id == null) {
			if (other.id != null)
				return false;
