...
public interface MonetaryFormatsSingletonSpi{
  ...
  default MonetaryAmountFormat getAmountFormat(Locale locale, String... providers){...}    <6>
  default MonetaryAmountFormat getAmountFormat(Locale locale, String... providers){...}    <6>
  default MonetaryAmountFormat getAmountFormat(String name, String... providers);          <6>

  default boolean isAvailable(Locale locale, String... providers){...}                     <7>
  default boolean isAvailable(AmountFormatQuery formatQuery){...}                          <7>
