...
public interface MonetaryAmountFormat extends MonetaryQuery<String> {
	 ...
	 * thrown.
	 * <p>
	 * This method uses a mainly delegates to contained {@link AmountStyle}.
	 * Additionally when no currency is on the input stream, the value of
	 * {@link #getDefaultCurrency()} is used instead of.
	 * <p>
	 * Additionally the effective implementation type returned can be determined
	 * by the {@link MonetaryContext} applied to the
	 * {@link MonetaryAmountFormat}. This formatter will call
	 * {@link MonetaryAmounts#getDefaultAmountType()} and will use the result
	 * returned to access a corresponding {@link MonetaryAmountFactory} to
	 * create the instance returned.
	 * 
	 * @param text
